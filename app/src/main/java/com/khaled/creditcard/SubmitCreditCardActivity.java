...
import com.khaled.creditcard.databinding.ActivitySubmitCreditCardBinding;
...
public class SubmitCreditCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activitySubmitCreditCardBinding.textExpiredDate.addTextChangedListener(new TextWatcher() {
